module ApplicationHelper
  ...
  def home_path
    "http://#{account_domain}/admin2/applications"
  end
  ...
  def app_name
    'Служба доставки EXLINE'
  end

  def install_delivery_path
    "http://rails.echelonsystems.ru/install_delivery?insales_id=454613&shop=myshop-eo558.myinsales.ru&user_email=s.sharshunov@gmail.com&user_id=496199"
  end
end
